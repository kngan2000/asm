		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					<div class="">
						<div class="logo">
							<a href="index.php"><img src="images/home/cartier1.jpg" style="width:24%" alt=""></a>
						</div>
					</div>
	...
	<section>
		<div class="container">
			<div class="row">
				...
				<div class="row">
					<p class="pull-left">Copyright © 2013 Cartier Company All rights reserved.</p>
